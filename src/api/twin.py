...
_TOPOLOGY = TwinTopology(
    ...
    nodes=[
        ...
        TwinNode(
            ...
            lnglat=(-95.86728, 29.33951),
            asset_id="RTU-01",
            model=TwinModelRef(ref="efm"),
        ),
        TwinNode(
            id="FLR", type="flare", name="Flare Stack", lnglat=(-95.86762, 29.33932), model=TwinModelRef(ref="flare")
        ),
        TwinNode(
            id="TWR",
            type="tower",
            name="Radio Tower",
            lnglat=(-95.86761, 29.33980),
            asset_id="RAD-01",
