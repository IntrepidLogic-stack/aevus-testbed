...
MIXED_ALARMS = [
    {
        ...
        "message": "Signal quality degraded below threshold (28%)",
        "risk_score": 85,
    ...
    },
    {
        ...
        "message": "Discharge pressure exceeding normal range (142 PSI)",
        "risk_score": 55,
        "detected_at": (datetime.utcnow() - timedelta(minutes=45)).isoformat(),
        "status": "open",
    },
    {
        "id": "ALM-DEMO-003",
        ...
        "asset_id": "RTU-01",
        "asset_name": "SCADAPack 470",
        "message": "Motor current elevated (112A, threshold 100A)",
        "risk_score": 40,
